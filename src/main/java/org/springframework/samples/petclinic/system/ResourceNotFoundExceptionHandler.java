...
/**
 * Global exception handler for ResourceNotFoundException. Returns a user-friendly 404
 * page without exposing technical details.
 *
 * @author Emerald Grove Pet Clinic Team
 */
@ControllerAdvice
